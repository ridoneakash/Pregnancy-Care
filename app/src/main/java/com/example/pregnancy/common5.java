...
public class common5 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_common5);
        ...
        buttonArrowB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    Intent intent1 = new Intent(common5.this, common4.class);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(common5.this, common.class);
                startActivity(intent1);
        ...
        hospital.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(common5.this, hospital.class);
                startActivity(intent1);
        ...
        exercise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(common5.this, exercise.class);
                startActivity(intent1);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.homeMenuId) {
            Toast.makeText(common5.this, "Home item clicked", Toast.LENGTH_SHORT).show();
        }

        else if(item.getItemId()==R.id.profileMenuId) {
            Toast.makeText(common5.this, "Chat item clicked", Toast.LENGTH_SHORT).show();
        }
