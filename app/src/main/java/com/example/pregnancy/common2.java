...
public class common2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonArrowF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(common2.this, common3.class);
        ...
        buttonArrowB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    Intent intent1 = new Intent(common2.this, common.class);
                    startActivity(intent1);
        ...
        mom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(common2.this, mom2.class);
                startActivity(intent1);
        ...
        child.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(common2.this, baby2.class);
                startActivity(intent1);
        ...
        hospital.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(common2.this, hospital.class);
                startActivity(intent1);
        ...
        exercise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(common2.this, exercise.class);
                startActivity(intent1);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.homeMenuId) {
            Toast.makeText(common2.this, "Home item clicked", Toast.LENGTH_SHORT).show();
        }

        else if(item.getItemId()==R.id.profileMenuId) {
            Toast.makeText(common2.this, "Chat item clicked", Toast.LENGTH_SHORT).show();
        }
