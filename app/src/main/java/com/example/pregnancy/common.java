...
public class common extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonArrowF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(common.this, common2.class);
        ...
        mom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(common.this, mom1.class);
                startActivity(intent1);
        ...
        child.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(common.this, baby1.class);
                startActivity(intent1);
        ...
        hospital.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(common.this, hospital.class);
                startActivity(intent1);
        ...
        exercise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(common.this, exercise.class);
                startActivity(intent1);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.homeMenuId) {
            Toast.makeText(common.this, "Home item clicked", Toast.LENGTH_SHORT).show();
        }

        else if(item.getItemId()==R.id.profileMenuId) {
            Toast.makeText(common.this, "Chat item clicked", Toast.LENGTH_SHORT).show();
        }
